...
NextRow:
    ...
    For Each entry In dict.Keys
        ...
        ' Apply data validation to columns (Budget and Nov-Oct months)
...
Private Sub CreateMajlisTable(ws As Worksheet)
    ...
    headers = Array("Region", "Majlis", "Tanziem", "Jamaat ID", "Name", _
                    "Budget", "Jul-Nov", "Dec", "Jan", "Feb", "Mar", _
                    "Apr", "May", "Jun", "Paid", "Rest", "Percentage")
...
Private Sub AddFormulaRow(ws As Worksheet, newRow As ListRow, tbl As ListObject)
    ...
    ' Jul-Nov is column 7, Jun is column 14
    colFirst = tbl.ListColumns("Jul-Nov").Range.Column
    colLast = tbl.ListColumns("Jun").Range.Column
